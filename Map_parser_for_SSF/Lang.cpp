...
const std::array<DictionaryBlock, std::to_underlying(STRINGS::STRINGS_SIZE)> Dictionary::m_data{
	{
		...
		{ STRINGS::ERROR_FILE , {{ { LANGUAGE::RUSSIAN, "Выбранный файл не является картой\n" }, { LANGUAGE::ENGLISH, "The specified file is not a map\n" } }} },
		{ STRINGS::CAMP_MAP , {{ { LANGUAGE::RUSSIAN, "\nЭто часть карты кампании, данный файл отвечает за локацию" }, { LANGUAGE::ENGLISH, "\nThis is a part of campaign map, this file is responsible for the location" } }} },
		{ STRINGS::CAMP_MIS , {{ { LANGUAGE::RUSSIAN, "\nЭто часть карты кампании, данный файл отвечает за миссию" }, { LANGUAGE::ENGLISH, "\nThis is a part of campaign map, this file is reponsible for the mission" } }} },
		{ STRINGS::MAP_SINGLE , {{ { LANGUAGE::RUSSIAN, "\nЭто одиночная карта" }, { LANGUAGE::ENGLISH, "\nThis is a singleplayer map" } }} },
		{ STRINGS::MAP_MULTI , {{ { LANGUAGE::RUSSIAN, "\nЭто карта мультиплеера" }, { LANGUAGE::ENGLISH, "\nThis is a multiplayer map" } }} },
		...
		{ STRINGS::MAP_SIZE , {{ { LANGUAGE::RUSSIAN, " размером {} x {}\nРазмер файла: {} байт" }, { LANGUAGE::ENGLISH, " with size {} x {}\nFile size: {} bytes" } }} }
	}
};
